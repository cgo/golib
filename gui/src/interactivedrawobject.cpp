...
template <>
void goGUI::InteractiveDrawObjectT < goPlot::Object2DBox > ::setObject (goAutoPtr<goPlot::Object2DBox> object_ptr)
{
    if (object_ptr)
    {
...
template <>
void goGUI::InteractiveDrawObjectT<goPlot::Object2DBox>::apply ()
{
