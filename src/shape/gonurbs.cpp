...
*       nurbs.operator(nurbs.getCurveLength()), you will get (0,0,0) as an answer.
...
*       nurbs.operator(nurbs.getCurveLength()) is requested.
...
**/
bool goNURBS::setControlPoints (const goList<goPointf>& points)
{
    if (points.getSize() < 4)
        return false;
...
bool goNURBS::setControlPoints (const goList<goPointd>& points)
{
    if (points.getSize() < 4)
        return false;
...
* @return True if successful, false otherwise.
**/
bool goNURBS::setControlPoints (goList<goPointf>::ConstElement* begin, goList<goPointf>::ConstElement* end, bool closed)
{
...
bool goNURBS::setControlPoints (goList<goPointd>::ConstElement* begin, goList<goPointd>::ConstElement* end, bool closed)
{
//    if (points.getSize() < 4)
//        return false;
...
* @return True if successful, false otherwise.
**/
bool goNURBS::setControlPoints (goList<goPointf>::ConstElement* begin, goIndex_t count, bool closed)
{
    if (begin == 0 || count < 4)
        return false;
...
* @return True if successful, false otherwise.
**/
bool goNURBS::setControlPoints (goList<goPointd>::ConstElement* begin, goIndex_t count, bool closed)
{
    if (begin == 0 || count < 4)
        return false;
