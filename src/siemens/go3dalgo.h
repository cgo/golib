 ...
 * d : The direction vector of length of the whole line (NOT unity!)
 * p1: Start point of the line to be clipped
 * xmin ... zmax: Min/max values on the 3 main axes of the box against which the line is to be clipped
 */
static void clipLiangBarsky (goDouble xmin, goDouble xmax, goDouble ymin, 
...
static
void
clipLiangBarsky (goDouble xmin, goDouble xmax, goDouble ymin, 
		 goDouble ymax, goDouble zmin, goDouble zmax,
		 go3Vector<goDouble>& d, go3Vector<goDouble>& p1,
		 go3Vector<goDouble>* start, 
		 go3Vector<goDouble>* end)
